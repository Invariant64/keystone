...
QEMU_FLAGS := -m $(QEMU_MEM) -smp $(QEMU_SMP) -nographic \
                ...
                -append "console=ttyS0 ro root=/dev/vda cma=1536M" \
                -object throttle-group,id=diskthrottle,x-bps-read=8388608,x-bps-write=4194304,x-iops-read=40,x-iops-write=20 \
                -blockdev driver=file,filename=$(BUILDROOT_BUILDDIR)/images/rootfs.ext2,node-name=hd0_file,cache.direct=true,cache.no-flush=true \
